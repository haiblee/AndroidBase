...
public class SQLCreator {
    ...
    public static String createTableSQL(String tableName, TableField[] fields){
        ...
        if(DEBUG) XLog.d(TAG, String.format("createTableSQL：[%s]",b.toString()));
        return b.toString();
    }
    ...
    private static String createFieldRowSQL(TableField field){
        ...
        if(DEBUG) XLog.d(TAG, String.format("createFieldRowSQL：[%s]，TableField = [%s]",b.toString(),field.toString()));
        return b.toString();
    }
    ...
    public static String createIndex(String tableName, TableField field){
        ...
        if(DEBUG) XLog.d(TAG, String.format("createIndex：[%s]，TableField = [%s]",result,field.toString()));
        return result;
    }
